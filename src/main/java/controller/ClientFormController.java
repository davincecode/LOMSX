...
public class ClientFormController {
    ...
    private final StringProperty clientNameProperty = new SimpleStringProperty("Client");
    ...
    public void initialize() {
        ...
        this.vBoxBroadcast.heightProperty().addListener((observableValue, oldValue, newValue) -> scrollPane.setVvalue((Double) newValue));
        this.vBoxFriends.heightProperty().addListener((observableValue, oldValue, newValue) -> scrollPane.setVvalue((Double) newValue));
        this.vBoxDM.heightProperty().addListener((observableValue, oldValue, newValue) -> scrollPane.setVvalue((Double) newValue));
