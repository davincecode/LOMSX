...
public class UserListCell extends ListCell<String> {
    ...
    private final ListView<String> friendsList;
    private final ListView<String> directMessage;
    private final DataOutputStream dataOutputStream;
    private final TextField txtMsg;
    private final TextField txtMsgFriends;
    private final TextField txtMsgDM;
    private final VBox vBox;
    private final VBox vBoxFriends;
    private final VBox vBoxDM;
    private final TabPane tabPane;
    private final Tab home;
    private final Tab addFriends;
    private final Tab directMsg;
    private final StringProperty clientNameProperty;
    private final OnLimeDB onLimeDB;
